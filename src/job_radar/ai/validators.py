...
def validate_resume_grounding(
    ...
    source_companies: set[str] = {
        _normalize(e.get("company", "")) for e in source_exp if isinstance(e, dict) and e.get("company")
    }
    ...
    source_institutions: set[str] = {
        _normalize(e.get("institution", "")) for e in source_edu if isinstance(e, dict) and e.get("institution")
    }
